...
public abstract class UserSecurityBase {
    ...
    public UserSecurityBase(UserAccountRepository userAccountRepository, PasswordEncoder passwordEncoder){
    ...
    public String checkCredentials(HttpServletRequest httpServletRequest) {
        ...
        var userAccount = new UserAccount().builder()
        ...
        if (userAccountFromDb != null && passwordEncoder.matches(userAccount.getPassword(), userAccountFromDb.getPassword())) {
