...
public class MessageServiceImpl implements MessageService {
    ...
    public void removeReceivedMessage(String username, long messageId){
        ...
        userAccountRepository.findByUsername(username).orElseThrow(() -> new UserNotFound("User not found"));
        var message = messageRepository.findById(messageId).orElseThrow(() -> new RuntimeException("Not found"));
